...
class KinectRecorder(object):
    def __init__(self, save_dir, rate=10, start_loop=True):
        """
        This node runs on a separate computer to collect the data of an additional kinect
        """
        ...
        rospy.Subscriber("/kinect2/sd/image_depth_rect", Image, self.store_latest_d_im)
